...
for k=1:ep
    bsc_p_learn=bsc_p_learn_st+(bsc_p_learn_main-bsc_p_learn_st)*k/ep;
    bsc_p_exec=bsc_p_exec_st+(bsc_p_exec_main-bsc_p_exec_st)*k/ep;
    ...
    parfor i=1:en
        ...
        %execution phase
        %[epoch_rew(:,i)]=EoC_par_function_UCB(scen,n,noa,ns,bits,best_rew,worst_rew,gamma,tau_k,ca,cs,pa,ps,ter,rew,temp_rew,counter,qc,qp,bsc_p_exec,end_learn_exec,0);
...
%p2=patch([14000 32000 32000 14000], [0 0 1.5 1.5],'c')
%set(p2, 'FaceAlpha', 0.2) %setting the transparency of the 