function [rew,qp_table,qc_table,counter]=EoC_par_function(scen,n,noa,ns,bits,best_rew,worst_rew,goal_set,gamma,tau_k,ca,cs,pa,ps,ter,rew,temp_rew,counter,qc_table,qp_table,bsc_p,end_learn,update_tables)
...
stuck_counter=0;
        ...
        %episode run    
            while 3==3    
                ...
                [ps,~,ter]=envir(ps,pa,n,noa,goal_set); 
