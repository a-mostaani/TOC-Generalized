function [rew,qp_table,qc_table,counter]=EoC_corrected_sync_encoded_UCB(scen,n,noa,ns,bits,inf_bits,best_rew,worst_rew,~,gamma,~,~,cs,~,~,~,rew,~,counter,qc_table,qp_table,bsc_p,end_learn,update_tables)
