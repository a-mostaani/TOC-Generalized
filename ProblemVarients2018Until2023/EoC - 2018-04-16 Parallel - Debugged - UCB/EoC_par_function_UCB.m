function [rew,qp_table,qc_table,counter]=EoC_par_function_UCB(scen,n,noa,ns,bits,best_rew,worst_rew,gamma,tau_k,ca,cs,pa,ps,ter,rew,temp_rew,counter,qc_table,qp_table,bsc_p,end_learn,update_tables)
...
% %                 end
                ...
                if ter>=2 
                    ...
                    temp_rew=3*gamma^(counter(i));%*gamma^(counter(i));
                    rew_winner=[];
                    for ii=1:noa
                        if ps(ii)==n^2
                            rew_winner=[rew_winner,ii];
                ...
                elseif ter==1
                    temp_rew=1*gamma^(counter(i));%*gamma^(counter(i));
                    rew_winner=[];
                    for ii=1:noa
                        if ps(ii)==n^2
                            rew_winner=[rew_winner,ii];
