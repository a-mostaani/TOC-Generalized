function [pa] = ppolicy_customized_nbits_UCB_bestrew_ma(ps,cs,scen,tau,qp_table,NE_table,ucb_counter,ns,end_learn,best_rew)
                ...
                if noa>2
                    for i=1:noa
                        ...
                        if rr<=epsilon
                            ...
                            [val,pa(i)]=max(qp_table(i,ps(i),bi2de(cs_new(i,:))+1,:));
                        end
                    end 
                else
                    for i=1:noa
