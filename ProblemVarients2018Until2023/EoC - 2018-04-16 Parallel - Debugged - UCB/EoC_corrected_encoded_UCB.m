function [rew,qp_table,qc_table,counter]=EoC_corrected_encoded_UCB(scen,n,noa,ns,bits,inf_bits,best_rew,~,~,gamma,tau_k,ca,cs,pa,ps,ter,rew,temp_rew,counter,qc_table,qp_table,bsc_p,end_learn,update_tables)
...
stuck_counter=0;
        ...
        %episode run    
            while 3==3    
                ...
                [ca_tilde] = cpolicy_customized_nbits_UCB(ps,scen,tau,qc_table,NC_table,ucb_counter,ns,end_learn);
                                                                
                %Update UCBC counter
                NC_table(1,ps(1),bi2de(ca_tilde(1,:))+1)=NC_table(1,ps(1),bi2de(ca_tilde(1,:))+1)+1;
                NC_table(2,ps(2),bi2de(ca_tilde(2,:))+1)=NC_table(2,ps(2),bi2de(ca_tilde(2,:))+1)+1;
                ...
                %Sending cs_beforechannel to channel and receiving
                %rec message
