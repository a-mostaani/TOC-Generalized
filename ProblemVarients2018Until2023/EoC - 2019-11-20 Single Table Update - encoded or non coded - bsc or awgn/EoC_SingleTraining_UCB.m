function [rew,qp_table,qc_table,counter]=EoC_SingleTraining_UCB(scen,n,noa,ns,bits,best_rew,worst_rew,gamma,tau_k,ca,cs,pa,ps,ter,rew,temp_rew,counter,qc_table,qp_table,bsc_p,ch_type,end_learn,update_tables)
...
stuck_counter=0;
        ...
        %episode run    
            while 3==3    
                ...
                [ca] = cpolicy_SingleTable_UCB(ps,scen,tau,qc_table,NC_table,ucb_counter,ns,end_learn);
