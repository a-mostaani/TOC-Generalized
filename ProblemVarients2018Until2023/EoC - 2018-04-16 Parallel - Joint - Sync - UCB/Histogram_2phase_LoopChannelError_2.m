...
for k=1:ep
    ...
    for i=1:en
        ...
        %execution phase
        [epoch_rew(:,i),epoch_NC_table(i,:,:,:),epoch_NE_table(i,:,:,:,:)]=Hist_EoC_corrected_sync_UCB(scen,n,noa,ns,bits,best_rew,worst_rew,goal_set,gamma,tau_k,ca,cs,pa,ps,ter,rew,temp_rew,counter,qc,qp,bsc_p_exec,end_learn_exec,0);
