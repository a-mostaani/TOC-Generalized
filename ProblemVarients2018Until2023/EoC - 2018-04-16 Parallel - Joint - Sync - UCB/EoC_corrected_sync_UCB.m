function [rew,q_table,counter]=EoC_corrected_sync_UCB(scen,n,noa,ns,bits,best_rew,~,~,gamma,~,~,cs,~,~,~,rew,~,counter,qc_table,qp_table,bsc_p,end_learn,update_tables)
