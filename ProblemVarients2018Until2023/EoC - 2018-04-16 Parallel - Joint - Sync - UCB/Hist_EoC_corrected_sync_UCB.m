function [rew,NC_table,NE_table,qp_table,qc_table]=Hist_EoC_corrected_sync_UCB(scen,n,noa,ns,bits,best_rew,worst_rew,goal_set,gamma,tau_k,ca,cs,pa,ps,ter,rew,temp_rew,counter,qc_table,qp_table,bsc_p,end_learn,update_tables)
...
% % % %             saved_qp_6(i,:)=qp_table(1,n^2-n,1,:);
        ...
        NC_table=NC_table-0.001*ones(2,n^2,2^bits);                                                                             248
