function [rew,qp_table,qc_table,counter]=EoC_corrected_UCB_2(scen,n,noa,ns,bits,best_rew,worst_rew,gamma,tau_k,ca,cs,pa,ps,ter,rew,temp_rew,counter,qc_table,qp_table,bsc_p,end_learn,update_tables,goal_set)
...
%Latest functionalities:
            % * Goal changing
            % * UCB constant gets updated wrt best_rew
            % * Change the way objective function is calculated in --
            %   -- "%episode summerize" line 239
...
stuck_counter=0;
        ...
        %episode run    
            while 3==3    
                ...
                [ca] = cpolicy_customized_nbits_UCB_bestrew(ps,scen,tau,qc_table,NC_table,ucb_counter,ns,end_learn,best_rew);
