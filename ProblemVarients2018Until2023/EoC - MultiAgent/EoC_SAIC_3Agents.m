function [rew,qp_table,qc_table,counter,NE_table_emerged]=EoC_SAIC_3Agents(scen,n,noa,ns,bits,inf_bits,best_rew,worst_rew,goal_set,gamma,tau_k,ca,cs,pa,ps,ter,rew,temp_rew,counter,qc_table,qp_table,bsc_p,end_learn,update_tables,policy)
 if ~exist('policy')
...
%load('agreggated_states_n3_g9_infbits2_noa2', 'ag_states_median');
%load('agreggated_states_n3_g9_infbits2_noa2_ns12k', 'ag_states_median');
%load('agreggated_states_n3_g9_infbits2_noa2_ns120k','ag_states_median');
...
% ag_states = [1  2  4  0  0  0  0  0  0  0;
%              3  4  6  7  9  10 13 0  0  0;
%              8 11 14  0  0  0  0  0  0  0;
%              15 12 0  0  0  0  0  0  0  0]; %n4g16bits2
