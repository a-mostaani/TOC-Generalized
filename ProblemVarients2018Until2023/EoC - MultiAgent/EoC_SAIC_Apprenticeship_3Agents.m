function [rew,qp_table_main,qc_table,counter,NE_table_emerged]=EoC_SAIC_Apprenticeship_3Agents(scen,n,noa,ns,bits,inf_bits,best_rew,worst_rew,goal_set,gamma,tau_k,ca,cs,pa,ps,ter,rew,temp_rew,counter,qc_table,qp_table_main,bsc_p,end_learn,update_tables)
%Note: this is the later version of the code titled EoC_SAIC_ActorCritic_3Agents
%use this function instead of the latter. 29/06/2022
