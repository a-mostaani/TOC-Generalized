...
[kmkm,C]=kmedoids(V_o_1_weighted,syms,'Distance','euclidean');
...
save('agreggated_states_g22_syms5', 'ag_states') 
figure
...
%% State aggregation according to actions
...
function pi = compute_pi(q_table, goal_set, n)
    pi = zeros(n^2,n^2,2);
    joint_act_ind = 0;
    ...
    for kk = 1: n*n
        ...
        for ll = 1:n*n
            ...
            pi(kk,ll,1) = dec_joint_act_ind(1);
            pi(kk,ll,2) = dec_joint_act_ind(2);
        end
